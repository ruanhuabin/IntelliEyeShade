...
<div id="wrapper">
		...
		<div id="mainBg">
			<div id="mainPanel">
				...
				<div id="right">
					...
					<form name="loginForm" action="<%=path%>/admin/Administrator_login.action" method="post">
					<!-- start of login form -->
					<div id="welcome">
	...
	<div id="footer">
		<div id="text">Copyright © 2009-2017 All Rights Reserved Powered By Ruan Huabin</div>
	</div>
</div>
</body>
</html>